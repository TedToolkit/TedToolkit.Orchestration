...
internal static class PipelineDiagnostics
{
    ...
    internal static readonly DiagnosticDescriptor ModifierOutsideConfiguration = Create("TTP017", "Node modifier used outside configuration",
        "Modifier '{0}' only declares node behavior inside Configuration; this call has no runtime effect", DiagnosticSeverity.Warning);
